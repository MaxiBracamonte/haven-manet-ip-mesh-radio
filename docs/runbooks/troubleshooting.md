...
- If your IP is **not** in the `10.41.x.x` range, your device may have connected to a different network — check you joined `green` or the point’s client SSID (e.g. `blue`), not your home WiFi
